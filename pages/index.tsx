    ...
    <>
      ...
      <main className={styles.main}>
        ...
        <div className={styles.content}>
          ...
          <section className={styles.section}>
            <Reveal>
                <Preview title="Personal Design Work" caption="Posters and such designed in my free time." img={poster} imgalt="Poster for The Strokes' Machu Picchu" href="/aboutme"/>
            </Reveal>
          </section>
        </div>
        <Footer />
